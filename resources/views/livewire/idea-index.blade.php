...
<div 
    ...
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        ...
        @if ($hasVoted)
            <div class="mt-8">
                <button wire:click="vote" class="w-20 bg-blue text-white border border-blue hover:bg-blue-hover font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">Voted</button>
            </div>
        @else
            <div class="mt-8">
                <button wire:click="vote" class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">Vote</button>
            </div>
        @endif
    ...
    <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
        ...
        <div class="w-full flex flex-col justify-between mx-2 md:mx-4">
            ...
            <div class="flex flex-com md:flex-row md:items-center justify-between mt-6">

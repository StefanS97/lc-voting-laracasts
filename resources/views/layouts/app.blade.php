    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex flex-col md:flex-row">
            <div class="w-70 mx-auto md:mx-0 md:mr-5">
                <div class="bg-white md:sticky md:top-8 sticky top-8 border-2 border-blue rounded-xl mt-16"
                    ...
                    <form class="space-y-4 px-4 py-6" action="#" method="POST">
                        <div>
                            <input class="w-full text-sm bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2" 
